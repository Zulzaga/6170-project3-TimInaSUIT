...
emailNotifier.sendNotification = function (user){
    ...
    if (user.createdAt){ // only for sending activation code to user
        // setup e-mail data
        var mailOptions = {
        ...
        var mailOptions = {
            ...
            text: "You have a new message on Tim in a Suit.", // plaintext body
            html: "Hi " + user.username + "," + "<br>" + "<br>" + "You have a new message on Tim in a Suit" + "<br>" + "<br>" + "Best," + "<br>" + "<br>" + "Tim in a Suit Team" // html body
        };
    }
